...
create view "SYSTEM"."THRESHOLDVIOLATIONS_BATTERYVOLTAGE_V" as select * from "SYSTEM"."THRESHOLD_VIOLATIONS_BATTERYVOLTAGE";
create view "SYSTEM"."THRESHOLDVIOLATIONS_BRAKETEMP_V" as select * from "SYSTEM"."THRESHOLD_VIOLATIONS_BRAKETEMP";
